# apps/mrenlargementapp/models.py
import json
from django.db import models

class SafeJSONField(models.JSONField):
    """
    Custom JSONField that safely handles both JSON strings and already parsed
    Python objects (dict/list) returned by the database driver.
    """
...
class DraftEnlargement(models.Model):
    ...
    data = models.JSONField(db_column='Data', default=dict)  # we keep normal JSONField here
    ...
    class Meta:
        managed = False
        db_table = '"mcmis"."Mr_DraftEnlargement"'
...
class EnlargeMineralRight(models.Model):
    ...
    geocoordinate = SafeJSONField(db_column='Geocoordinate', blank=True, null=True)   # custom field
