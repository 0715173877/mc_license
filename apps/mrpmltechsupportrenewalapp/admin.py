...
@admin.register(DraftPmlTechSupportRenewal)
class DraftPmlTechSupportRenewalAdmin(admin.ModelAdmin):
...
class PmlTechnicalSupportAdmin(admin.ModelAdmin):
    list_display = ('pml_technical_support_id', 'licence_id', 'status_id', 'is_fresh_application')
